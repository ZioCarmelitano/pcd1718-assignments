...
import pcd.ass02.ex1.ForkJoinOccurrencesCounter;
import pcd.ass02.ex2.VertxOccurrencesCounter;
...
public class Benchmark {
    ...
    private static long vertxSearch() {
        ...
        final OccurrencesCounter counter = new VertxOccurrencesCounter((searchStatistics) -> {},
                statistics -> executionTime[0] = statistics.get(1));
